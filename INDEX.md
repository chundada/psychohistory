...
graph TD
    ...
    subgraph "🎲 Game Theory Frameworks"
        GT_ELITE["gt-game-theory-elite-overproduction<br/>精英过剩与革命周期"]
        GT_IMMIG["gt-game-theory-immigration-trap<br/>移民陷阱"]
        GT_ESCAL["gt-game-theory-escalation<br/>升级法则"]
        GT_PROX["gt-game-theory-proximity<br/>邻近法则"]
        GT_ASYMM["gt-game-theory-asymmetry<br/>非对称法则"]
    end

    subgraph "🌍 Geopolitics"
        GEO_CURR["gt-geopolitics-currency-war<br/>货币战争"]
        GEO_3LAWS["gt-geopolitics-three-laws<br/>地缘政治三定律"]
        GEO_CHOKE["gt-geopolitics-chokepoint<br/>咽喉要道控制"]
    end

    subgraph "🏛️ Civilization Patterns"
        CIV_EOC["gt-civilization-eoc-model<br/>EOC三维动力模型"]
        CIV_ASAB["gt-civilization-asabiyyah<br/>阿萨比亚定律"]
        CIV_SCLER["gt-civilization-institutional-sclerosis<br/>制度硬化"]
        CIV_FERT["gt-civilization-fertility-leading-indicator<br/>生育率先行指标"]
        CIV_MIC["gt-civilization-military-industrial-complex<br/>军事-工业复合体"]
        CIV_ELITE["gt-civilization-elite-overproduction<br/>精英过度生产"]
        CIV_MERC["gt-civilization-mercenary-overthrow<br/>雇佣兵反噬"]
        CIV_SUPER["gt-civilization-three-superstructures<br/>三大超结构"]
    end

    subgraph "🙏 Religion & Narrative"
        REL_MONEY["gt-religion-money-as-god<br/>货币作为上帝"]
        REL_PAX["gt-religion-pax-judaica<br/>Pax Judaica"]
        REL_ESCHCON["gt-religion-eschatological-convergence<br/>七大末世论汇聚"]
        REL_COMMIE["gt-religion-communism-as-anti-religion<br/>共产主义反宗教武器"]
        REL_KABBAL["gt-religion-kabbalistic-redemption<br/>卡巴拉救赎"]
        REL_MESS["gt-religion-messianic-accelerationism<br/>弥赛亚加速主义"]
        REL_AI["gt-religion-ai-stargate-rapture<br/>AI星门项目"]
        REL_ESCHGEO["gt-religion-eschatology-geopolitics<br/>末世论地缘编码"]
    end

    subgraph "🔮 Predictive Models ⭐"
        PRE_MEC["gt-predictive-002<br/>M×E×C胜率评估"]
        PRE_TRIPLE["gt-predictive-003<br/>多重框架汇聚验证"]
        PRE_CHESS["gt-predictive-006<br/>国际象棋大战略"]
        PRE_DECLINE["gt-predictive-005<br/>帝国衰退三指标"]
        PRE_ESCH["gt-predictive-001<br/>末法汇聚预测"]
        PRE_HIST["gt-predictive-010<br/>历史类比预测"]
        PRE_AICULT["gt-predictive-011<br/>AI祭仪预测"]
        PRE_KABBAL["gt-predictive-009<br/>喀巴拉加速主义"]
        PRE_MOSAIC["gt-predictive-012<br/>马赛克防御"]
        PRE_DOLLAR["gt-predictive-008<br/>美元瘾症"]
        PRE_CHOKE["gt-predictive-015<br/>咽喉点控制"]
        PRE_CIVWAR["gt-predictive-013<br/>内战投射理论"]
    end

    subgraph "⚠️ Failure Mode"
        FAI_AICON["gt-failure-ai-consciousness<br/>AI意识幻觉"]
        FAI_PARADOX["gt-failure-advantage-paradox<br/>优势即劣势"]
        FAI_DICHOT["gt-failure-false-dichotomy<br/>虚假二元对立"]
        FAI_DK["gt-failure-dunning-kruger<br/>达克效应"]
        FAI_NATION["gt-failure-nation-state<br/>民族国家幻觉"]
        FAI_GREAT["gt-failure-great-man<br/>伟人迷思"]
        FAI_CORR["gt-failure-correlation-causation<br/>相关即因果"]
    end

    subgraph "📖 Glossary"
        GLOSS_GT["gt-glossary-game-theory-definition<br/>博弈论三组件"]
        GLOSS_EOC["gt-glossary-cohesion-openness-energy<br/>EOC三维定义"]
        GLOSS_REAL["gt-glossary-reality-hallucination<br/>洞穴寓言"]
        GLOSS_TECH["gt-glossary-technate<br/>Technate"]
        GLOSS_MOSAIC["gt-glossary-mosaic-defense<br/>马赛克防御"]
        GLOSS_SUPER["gt-glossary-superstructure<br/>超级结构"]
        GLOSS_ASYMM["gt-glossary-asymmetry<br/>非对称法则定义"]
        GLOSS_ELITE["gt-glossary-elite-overproduction<br/>精英过剩定义"]
        GLOSS_NASH["gt-glossary-nash-equilibrium<br/>纳什均衡批判"]
    end

    %% ── Civilization Patterns ──
    CIV_EOC -->|depends-on| CIV_ASAB
    CIV_FERT -->|depends-on| CIV_SUPER
    CIV_MIC -->|depends-on| CIV_SCLER
    CIV_MIC -->|depends-on| CIV_ELITE
    CIV_MERC -->|depends-on| CIV_ASAB

    CIV_EOC -.->|composes-with| CIV_ELITE
    CIV_EOC -.->|composes-with| CIV_SCLER
    CIV_ASAB -.->|composes-with| CIV_EOC
    CIV_ASAB -.->|composes-with| CIV_MERC
    CIV_SCLER -.->|composes-with| CIV_ELITE
    CIV_SCLER -.->|composes-with| CIV_EOC
    CIV_FERT -.->|composes-with| CIV_EOC
    CIV_FERT -.->|composes-with| CIV_ELITE
    CIV_MIC -.->|composes-with| CIV_MERC
    CIV_ELITE -.->|composes-with| CIV_SCLER
    CIV_ELITE -.->|composes-with| CIV_EOC
    CIV_MERC -.->|composes-with| CIV_MIC
    CIV_SUPER -.->|composes-with| CIV_FERT
    CIV_SUPER -.->|composes-with| CIV_EOC

    CIV_ASAB -.-x|contrasts| CIV_SCLER
    CIV_ASAB -.-x|contrasts| CIV_ELITE
    CIV_SCLER -.-x|contrasts| CIV_ASAB
    CIV_ELITE -.-x|contrasts| CIV_ASAB

    %% ── Religion & Narrative ──
    REL_MONEY -->|depends-on| REL_ESCHGEO
    REL_PAX -->|depends-on| REL_MESS
    REL_PAX -->|depends-on| REL_KABBAL
    REL_ESCHCON -->|depends-on| REL_ESCHGEO
    REL_MESS -->|depends-on| REL_ESCHGEO
    REL_AI -->|depends-on| REL_ESCHGEO

    REL_MONEY -.->|composes-with| REL_AI
    REL_MONEY -.->|composes-with| REL_PAX
    REL_PAX -.->|composes-with| REL_ESCHCON
    REL_PAX -.->|composes-with| REL_AI
    REL_ESCHCON -.->|composes-with| REL_MESS
    REL_ESCHCON -.->|composes-with| REL_PAX
    REL_COMMIE -.->|composes-with| REL_ESCHCON
    REL_KABBAL -.->|composes-with| REL_MESS
    REL_KABBAL -.->|composes-with| REL_PAX
    REL_MESS -.->|composes-with| REL_KABBAL
    REL_MESS -.->|composes-with| REL_ESCHCON
    REL_MESS -.->|composes-with| REL_PAX
    REL_AI -.->|composes-with| REL_MONEY
    REL_AI -.->|composes-with| REL_ESCHCON
    REL_ESCHGEO -.->|composes-with| REL_ESCHCON
    REL_ESCHGEO -.->|composes-with| REL_MESS

    REL_MONEY -.-x|contrasts| REL_COMMIE

    %% ── Predictive Models ⭐ ──
    PRE_TRIPLE -->|CENTRAL HUB| PRE_ESCH
    PRE_TRIPLE -->|CENTRAL HUB| PRE_DECLINE
    PRE_TRIPLE -.->|composes-with| PRE_CIVWAR

    PRE_MEC -.->|composes-with| PRE_ESCH
    PRE_MEC -.->|composes-with| PRE_KABBAL
    PRE_CHESS -.->|composes-with| PRE_HIST
    PRE_DECLINE -.->|composes-with| PRE_CIVWAR
    PRE_ESCH -.->|composes-with| PRE_MEC
    PRE_HIST -.->|composes-with| PRE_CIVWAR
    PRE_HIST -.->|composes-with| PRE_CHESS
    PRE_AICULT -.->|composes-with| PRE_CIVWAR
    PRE_AICULT -.->|composes-with| PRE_MEC
    PRE_KABBAL -.->|composes-with| PRE_CHESS
    PRE_KABBAL -.->|composes-with| PRE_CHOKE
    PRE_MOSAIC -.->|composes-with| PRE_MEC
    PRE_DOLLAR -.->|composes-with| PRE_HIST
    PRE_CHOKE -.->|composes-with| PRE_HIST
    PRE_CIVWAR -.->|composes-with| PRE_CHESS
    PRE_CIVWAR -.->|composes-with| PRE_KABBAL

    PRE_ESCH -.-x|contrasts| PRE_HIST
    PRE_HIST -.-x|contrasts| PRE_ESCH
    PRE_MOSAIC -.-x|contrasts| PRE_CHESS
    PRE_DOLLAR -.-x|contrasts| PRE_ESCH

    %% ── Cross-group links ──
    GT_ASYMM -.->|composes-with| CIV_EOC
    GT_ASYMM -.->|composes-with| CIV_ELITE
    GT_ASYMM -.->|composes-with| CIV_ASAB
    PRE_ESCH -->|depends-on| REL_ESCHGEO
```
---
